...
//        rect(this.x, this.y, this.width, this.length);
        image(houses[1], this.x, this.yreal, this.width * 2, this.length * 2);
...
//        fill(100);
//        rect(this.x, this.y, this.width, this.length);
        image(houses[2], this.x, this.yreal, this.width * 2, this.length * 2);
    }
    if(this.type == 3) {
//        fill(245);
//        rect(this.x, this.y, this.width, this.length);
        image(houses[3], this.x, this.yreal, this.width * 2, this.length * 2);
    }
